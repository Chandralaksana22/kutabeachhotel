...
import DiningSectionDetail from '~/components/Section/Detail/DiningSectionDetail.vue'

import { getDiningConfig } from '~/server/general';
...
<template>
  ...
  <div class="py-20 container mx-auto px-10">
  ...
  <DiningSectionDetail :dining="dining"/>
  <Footer/>
</template>
