...
import RoomSectionDetail from '~/components/Section/Detail/RoomSectionDetail.vue'

import { getRoomConfig } from '~/server/general';
...
<template>
    ...
    <div class="py-5 md:py-20 container mx-auto px-5 md:px-10">
        ...
        <div class="flex md:hidden items-center justify-center gap-4 mt-3">
